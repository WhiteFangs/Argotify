...
chrome.runtime.onMessage.addListener(function (msg, sender, response) {
	if (msg.from === 'popup' && msg.variables != undefined && msg.variables.verlanifyValue != undefined && msg.variables.weshifyValue != undefined && msg.variables.simplifyValue != undefined ) {
		simplifyValue = msg.variables.simplifyValue;
		weshifyValue = msg.variables.weshifyValue;
		verlanifyValue = msg.variables.verlanifyValue;
